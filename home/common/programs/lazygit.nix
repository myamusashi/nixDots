    ...
    settings = {
      gui = {
        ...
        theme = {
          ...
          searchingActiveBorderColor = ["#7E9CD8" "bold"];
          optionsTextColor = ["#7FB4CA"];
          selectedLineBgColor = ["#7FB4CA"];
          inactiveViewSelectedLineBgColor = ["bold"];
          cherryPickedCommitFgColor = ["#7FB4CA"];
          cherryPickedCommitBgColor = ["#7E9CD8"];
          markedBaseCommitFgColor = ["#7FB4CA"];
          markedBaseCommitBgColor = ["#E6C384"];
          unstagedChangesColor = ["#FF5D62"];

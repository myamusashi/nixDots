...

{
  ...
  fileSystems."/" =
    {
      device = "/dev/disk/by-uuid/8dd367e0-1f49-4060-88df-a937082d5dbe";
      fsType = "ext4";
    };

  fileSystems."/boot" =
    {
      device = "/dev/disk/by-uuid/A899-93F9";
      fsType = "vfat";
      options = [ "fmask=0077" "dmask=0077" ];
    };

  swapDevices =
    [{ device = "/dev/disk/by-uuid/92ca6901-5d8d-4a9d-9711-6e37fcf5244a"; }];
